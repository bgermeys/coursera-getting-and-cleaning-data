# See the readme and codebook-files for further background information

# Goal: create an R script called run_analysis.R that does the following.
...
# Set the working directory -- modify if necessary
setwd("/Users/bart/Documents/R/Coursera/Cursus3/project")
